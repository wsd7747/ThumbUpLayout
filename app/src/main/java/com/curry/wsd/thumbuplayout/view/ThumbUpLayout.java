package com.curry.wsd.thumbuplayout.view;
...
import com.curry.wsd.thumbuplayout.R;
...
public class ThumbUpLayout extends RelativeLayout {
    ...
    public ThumbUpLayout(@NonNull Context context) {
        this(context,null);
    }

    public ThumbUpLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ThumbUpLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.ThumbUpLayout);
        mEnterDuration = a.getInt(R.styleable.ThumbUpLayout_enter_duration,mEnterDuration);
        mDuration = a.getInt(R.styleable.ThumbUpLayout_duration,mDuration);
        mScale = a.getFloat(R.styleable.ThumbUpLayout_scale,mScale);
        mIsSameSize = a.getBoolean(R.styleable.ThumbUpLayout_same_size,mIsSameSize);
